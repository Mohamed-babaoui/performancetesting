...
public class Methods {
    ...
    public static void sendMail(String graphWS, String newTableWS, String oldTableWS, String compareTableWS, Date startDate, Date endDate, String conclusion, String oldStartDate, String oldVersion) throws MessagingException, IOException {
