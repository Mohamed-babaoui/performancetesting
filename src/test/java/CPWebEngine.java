...
import simulations.CPWebSimulation;
...
public class CPWebEngine {
    public static void main(String[] args) throws IOException, MessagingException {
        ...
        GatlingPropertiesBuilder props = new GatlingPropertiesBuilder()
                ...
                .simulationClass(CPWebSimulation.class.getName());
    ...
    private static Map<String, Double> parseAverages(String filePath) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                System.out.println("TOKENS PRINTING _________________________");
