...
public class Scenario2TestSampAdv extends BaseTest {
    ...
    public void testScenario2Adv(long duration) {
        ...
        while (System.currentTimeMillis() < endTime) {
            try {
                ...
                try {
                    ...
                    // Capture screenshot
                    String screenshotPath = captureScreenshot("booking_number_failure");
                    if (screenshotPath != null) {
                ...
                try {
                    ...
                    // Capture screenshot
                    String screenshotPath = captureScreenshot("post_confirmation_failure");
                    if (screenshotPath != null) {
                        test.addScreenCaptureFromPath(screenshotPath);
                    }
                }
                ...
                // Capture screenshot
                String screenshotPath = captureScreenshot("unexpected_error");
                if (screenshotPath != null) {
                    test.addScreenCaptureFromPath(screenshotPath);
                }
            } finally {
        ...
        try {
            ...
            // Capture screenshot
            String screenshotPath = captureScreenshot("report_generation_failure");
            if (screenshotPath != null) {
                test.addScreenCaptureFromPath(screenshotPath);
            }
        }
